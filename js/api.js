...
var Api = (function() {
    ...
    // อัปโหลดไฟล์ทับตำแหน่งเดิมได้เสมอ (x-upsert) — แต่ละรายการค่าใช้จ่ายแนบใบเสร็จ
    // ได้หลายไฟล์ (BR-04) โดยแต่ละไฟล์มี path ของตัวเอง การแนบไฟล์ใหม่ที่ path เดิม
    // จึงหมายถึงการแทนที่ไฟล์นั้นไฟล์เดียว ไม่ต้องลบเองก่อน
